...
CKEDITOR.editorConfig = function( config ) {
	...
	config.toolbar_default = [
	    ...
	    ['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],['ShowBlocks'],['Image','Capture'],['Maximize'],
	    '/',
    ...
    config.filebrowserImageUploadUrl = projectName+'/tools/ckeditor/imgupload'; //固定路径
};
