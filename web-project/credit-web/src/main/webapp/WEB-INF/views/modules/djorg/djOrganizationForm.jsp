...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/djorg/djOrganization/form?id=${djOrganization.id}&parent.id=${djOrganizationparent.id}">组织
		 <shiro:hasPermission name="djorg:djOrganization:edit">${not empty djOrganization.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="djorg:djOrganization:edit">查看</shiro:lacksPermission>
		 </a></li>
	</ul><br/>
