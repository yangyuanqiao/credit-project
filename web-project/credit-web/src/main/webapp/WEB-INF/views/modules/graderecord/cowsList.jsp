...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/graderecord/gradeRecord/cowsList">牛行评分记录列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="gradeRecord" action="${ctx}/graderecord/gradeRecord/cowsList" method="post" class="breadcrumb form-search">
