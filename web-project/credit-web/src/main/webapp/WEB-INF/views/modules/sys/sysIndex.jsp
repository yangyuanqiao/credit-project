...
<head>
	...
	<style type="text/css">
		...
		.icon {
    		background-image: url(${ctxStatic}/images/indexlogo.png);
   			 height: 50px;
    		position: absolute;
    		width: 50px;
		}
			...
			$("#menu a.menu").click(function(){
				...
				if ($(menuId).length > 0){
					...
					$.get($(this).attr("data-href"), function(data){
						...
						$("#left .accordion").hide();
						$("#left").append(data).css("backgroundColor","#50b2ea");;
	...
	<div id="main" class="hl_wrapper">
	    ...
	    <div class="container-fluid">
		    ...
		    <div id="footer" class="row-fluid">
	            Copyright &copy; 2012-${fns:getConfig('copyrightYear')} ${fns:getConfig('productName')} - Powered By <a href="http://Amass.com" target="_blank">Amass</a> ${fns:getConfig('version')}
			</div>
		</div>
	</div>
	<script type="text/javascript"> 
