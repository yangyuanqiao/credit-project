...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/graderecord/gradeRecord/renthouselist">出租屋评分记录列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="gradeRecord" action="${ctx}/graderecord/gradeRecord/renthouselist" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>出租屋门牌号：</label>
				<form:input path="houseBase.houseNum" htmlEscape="false" maxlength="40" class="input-medium"/>
			</li>
			<li><label>评定开始时间：</label>
				<input name="beginTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="${gradeRecord.beginTime}"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="gradeRecord">
			<tr>
				...
				<td>
					${gradeRecord.houseBase.houseNum}
				</td>
				<td>
