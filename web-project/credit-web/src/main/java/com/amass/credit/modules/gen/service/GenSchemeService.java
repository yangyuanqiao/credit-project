 ...
 */
package com.amass.credit.modules.gen.service;
...
import com.amass.credit.modules.gen.dao.GenSchemeDao;
import com.amass.credit.modules.gen.dao.GenTableColumnDao;
import com.amass.credit.modules.gen.dao.GenTableDao;
import com.amass.credit.modules.gen.entity.GenConfig;
import com.amass.credit.modules.gen.entity.GenScheme;
import com.amass.credit.modules.gen.entity.GenTable;
import com.amass.credit.modules.gen.entity.GenTableColumn;
import com.amass.credit.modules.gen.entity.GenTemplate;
import com.amass.credit.modules.gen.util.GenUtils;
...
//	private GenTemplateDao genTemplateDao;
	...
	private String generateCode(GenScheme genScheme){
		...
		for (GenTemplate tpl : templateList){
			result.append(GenUtils.generateToFile(tpl, model, genScheme.getReplaceFile()));//生成不了dao.xml???是因为没有勾选生成insert、update等操作
		}
