...
public class GenTableService extends BaseService {
	...
	public void delete(GenTable genTable) {
		...
		GenTableColumn gentablec = new GenTableColumn();
		gentablec.setDelFlag(GenTableColumn.DEL_FLAG_DELETE);
		gentablec.setGenTable(genTable);
		genTableColumnDao.deleteByGenTableId(gentablec);
	}
