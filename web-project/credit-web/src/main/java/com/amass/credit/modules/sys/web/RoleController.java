...
public class RoleController extends BaseController {
	...
	@Autowired
	private DjOrganizationService djorgService;
...
//		}
	...
	public String selectUserToRole(Role role, Model model) {
		...
		model.addAttribute("djorgList", djorgService.findAll());
	...
	public List<Map<String, Object>> users(String djorgId, HttpServletResponse response) {
