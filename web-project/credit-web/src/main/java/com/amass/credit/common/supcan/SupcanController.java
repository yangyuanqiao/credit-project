 ...
 */
package com.amass.credit.common.supcan;
...
import com.amass.credit.common.supcan.annotation.treelist.cols.SupGroup;
import com.amass.credit.common.supcan.treelist.TreeList;
import com.amass.credit.common.supcan.treelist.cols.Col;
import com.amass.credit.common.supcan.treelist.cols.Group;
...
public class SupcanController extends BaseController {
	...
	public TreeList treeList(@PathVariable("typeAlias") String typeAlias) {
		...
		if (useCache){
			Object object = JedisUtils.getObject(SUPCAN_CACHE+typeAlias);
			if (object != null){
		...
		// 如果使用Cache，则保存到Cache
		if (useCache){
			JedisUtils.setObject(SUPCAN_CACHE+typeAlias, treeList,0);
		}
