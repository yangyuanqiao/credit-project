...
import com.amass.credit.common.servlet.ValidateCodeServlet;
import com.amass.credit.common.utils.CookieUtils;
...
import com.amass.credit.modules.sys.security.FormAuthenticationFilter;
		...
		if (sessions.size() > 0){ 
			...
			if (UserUtils.getSubject().isAuthenticated()){
				for (Session session : sessions){
					if(session.getAttribute("principalId").equals(principal.getId()))
...
//		try {
//			byte[] bytes = com.amass.credit.common.utils.FileUtils.readFileToByteArray(
//					com.amass.credit.common.utils.FileUtils.getFile("c:\\sxt.dmp"));
...
//		System.out.println("==========================b");
	...
	public static boolean isValidateCodeLogin(String useruame, boolean isFail, boolean clean){
		Map<String, Integer> loginFailMap = (Map<String, Integer>)JedisUtils.getObject("DJ_SERVER:loginFailMap");
		if (loginFailMap==null){
			loginFailMap = Maps.newHashMap();
			JedisUtils.setObject("DJ_SERVER:loginFailMap", loginFailMap,0);
		}
