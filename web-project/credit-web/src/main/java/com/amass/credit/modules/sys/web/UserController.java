...
import com.amass.credit.common.utils.DateUtils;
...
import com.amass.credit.common.beanvalidator.BeanValidators;
...
public class UserController extends BaseController {
	...
	public String list(User user, HttpServletRequest request, HttpServletResponse response, Model model) throws Exception {
	...
	public String form(User user, Model model) {
		//若未分配组织，则先配置为本人所知的组织地址
		if(user.getDjorg() == null || user.getDjorg().getId() == null){
			user.setDjorg(UserUtils.getUser().getDjorg());
		}
	...
	public String save(User user, HttpServletRequest request, Model model, RedirectAttributes redirectAttributes) {
		...
		user.setDjorg(new DjOrganization(request.getParameter("djorg.id")));
		// 如果新密码为空，则不更换密码
	...
	public String getbyLoginName(String loginName, Model model) {
	...
	public List<Map<String, Object>> treeData(@RequestParam(required=false) String djorgId, HttpServletResponse response) {
		List<Map<String, Object>> mapList = Lists.newArrayList();
		List<User> list = systemService.findUserByDjorgId(djorgId);
