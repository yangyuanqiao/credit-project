...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/graderecord/gradeRecord/">模具企业评分记录列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="gradeRecord" action="${ctx}/graderecord/gradeRecord/" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			...
			<li><label>企业名称：</label>
				<form:input path="enterpriseBase.subName" htmlEscape="false" maxlength="40" class="input-medium"/>
			</li>
			<li><label>评定开始时间：</label>
				<input name="beginTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="${gradeRecord.beginTime}" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:false});"/>
			</li>
			<li><label>评定结束时间：</label>
				<input name="endTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate"
					value="${gradeRecord.endTime}"
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="gradeRecord">
			<tr>
				...
				<td>
					${gradeRecord.enterpriseBase.subName}
				</td>
				<td>
					${gradeRecord.score}
				</td>
