...
<head>
    ...
    function connect() {
        ...
        ws.onmessage = function (event) {
        	...
        	//'Received: ' + 
        	//转码
        	var msg = decodeURI(event.data);
        	//若果是自己发出的信息
        	if((msg).indexOf("<%=request.getParameter("username") %>:")>-1)
        		log(msg,true);
        	else
            	log(msg,false);
        };
    ...
    function log(message,isself) {
        ...
        $(document).ready(function(){
        	...
        	updateUrl('/server-web/meetsLive?username=<%=request.getParameter("username") %>&groupid=<%=request.getParameter("groupid") %>');
        	connect();
        });
    </script>
</head>
...
<div class="panel panel-primary gdialog" id="messageDialog" style="height: 90%;position: absolute;z-index: 1001;">
		  <div class="panel-heading">会议直播
		  ...
		  <div class="panel-footer" style="padding:5px 10px;text-align: center;padding-bottom: 20px;">
		  <div class="form-groupBuy">
				...
				<input type="text" class="textcontent" id="message"
					  style="width: 100%;font-size: 20px;" />
						     ...
						     <a type="button" id="echo" class="btn btn-success" onclick="echo();" style="width: 200px;"> 发送</a>
